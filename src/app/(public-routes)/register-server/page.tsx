...
import { RegisterServerForm } from '@/components/FormRegisterServer/register-server-form'; // Componente do formulário de registro de servidor
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center pt-20">
        <div className="w-full max-w-md px-4">
          {/* Formulário de Registro de Servidor */}
          <RegisterServerForm />
        </div>
      </div>
