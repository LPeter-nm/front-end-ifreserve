...
import { TypeUserForm } from '@/components/FormTypeUser/typeuser-form'; // Componente do formulário de seleção do tipo de usuário
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <Navbar
          rightContent={
            <Button
              ...
              className="bg-[#E3E3E3] cursor-pointer text-black w-24">
              Login
            </Button>
          }
        />
      ...
      <div className="flex-1 flex items-center justify-center pt-20">
        <div className="w-full max-w-md px-4">
          {/* Formulário de Seleção do Tipo de Usuário */}
          <TypeUserForm />
        </div>
      </div>
