...
import { useRouter, useSearchParams } from 'next/navigation'; // Importa useRouter para redirecionamento no cliente
...
import RegisterCompleteStudent from '@/components/CompleteRegister/student/register-complete-student';
import RegisterCompleteServer from '@/components/CompleteRegister/server/register-complete-server';
import RegisterCompleteExternal from '@/components/CompleteRegister/external/register-complete-external';

// --- Componente Principal ---
export default function CompleteExternal() {
  // --- Hooks de Navegação ---
