...
import { RegisterExternalForm } from '@/components/FormRegisterExternal/register-external-form'; // Componente do formulário de registro externo
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center pt-20">
        <div className="w-full max-w-md px-4 p-5">
          {/* Formulário de Registro Externo */}
