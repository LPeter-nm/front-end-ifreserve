    ...
    if (typeof window !== 'undefined') {
      try {
        ...
        if (!token) {
          ...
          router.push('/');
          console.warn('Token não encontrado no localStorage na página de solicitação de reserva.');
        ...
        console.error('Erro ao decodificar token em RequestReserve:', error);
    ...
    <div className="flex bg-[#ebe2e2] min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        <main className="p-4 flex-grow">
          ...
          {/* Formulário de solicitação de reserva de esporte */}
          <ReserveSportForm />
        </main>
...
export default RequestReservePage;
